...
<head>
    ...
    {{ HTML::style('freelancer/css/bootstrap.min.css') }}
    {{ HTML::style('freelancer/css/freelancer.css') }}
  ...
  <body id="page-top" class="index">
    ...
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="{{ asset('freelancer/img/profile.png') }}" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-3 portfolio-item">
                    <a href="#work-{{$work->id}}" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <img src="{{ asset($work->image) }}" class="img-responsive" alt="" />
                    </a>
                </div>
                @endforeach
            </div>
    ...
    <!-- Portfolio Modals -->
    @foreach ($works as $work)
    @include('partials.portfolio_modal')
    @endforeach
    ...
    {{ HTML::script('freelancer/js/classie.js') }}
    {{ HTML::script('freelancer/js/cbpAnimatedHeader.js') }}
    {{ HTML::script('freelancer/js/freelancer.js') }}
