...
<head>
    ...
    <!-- Add custom CSS here -->
    {{ HTML::style('landing/css/landing-page.css') }}
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    {{ HTML::image('landing/img/ipad.png', "", ['class' => 'img-responsive']) }}
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6">
                    {{ HTML::image('landing/img/doge.png', "", ['class' => 'img-responsive']) }}
                </div>
            </div>
    ...
    <div class="content-section-a">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
                    {{ HTML::image('landing/img/phones.png', "", ['class' => 'img-responsive']) }}
                </div>
            </div>
